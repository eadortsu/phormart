...
class Upload_model extends CI_Model
{
    ...
    public function post_mid_image_upload($file)
    {
        $this->my_upload->upload($file);
        if ($this->my_upload->uploaded == true) {
            $this->my_upload->file_new_name_body = 'image_750x415_' . uniqid();
            $this->my_upload->image_convert = 'jpg';
            $this->my_upload->jpeg_quality = 70;
            $this->my_upload->image_ratio_crop = true;
            $this->my_upload->image_resize = true;
    ...
    public function post_small_image_upload($file)
    {
        $this->my_upload->upload($file);
        if ($this->my_upload->uploaded == true) {
            $this->my_upload->file_new_name_body = 'image_100x75_' . uniqid();
            $this->my_upload->image_convert = 'jpg';
            $this->my_upload->jpeg_quality = 70;
            $this->my_upload->image_ratio_crop = true;
            $this->my_upload->image_resize = true;
    ...
    public function post_slider_image_upload($file)
    {
        $this->my_upload->upload($file);
        if ($this->my_upload->uploaded == true) {
            $this->my_upload->file_new_name_body = 'image_650x433_' . uniqid();
            $this->my_upload->image_convert = 'jpg';
            $this->my_upload->jpeg_quality = 70;
            $this->my_upload->image_ratio_crop = true;
            $this->my_upload->image_resize = true;
