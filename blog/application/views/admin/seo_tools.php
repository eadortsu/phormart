        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <select name="lang_id" class="form-control" onchange="window.location.href = '<?php echo base_url(); ?>'+'admin/seo_tools?lang='+this.value;">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-radio">
                        <input type="radio" name="last_modification" value="none" class="flat-red"> <span>&nbsp;<?php echo trans('none'); ?></span>
                    </div>

                    <div class="form-radio">
                        <input type="radio" name="last_modification" value="server_response" class="flat-red"
                               checked> <span>&nbsp;<?php echo trans('server_response'); ?></span>
                    </div>

                    <div class="form-radio">
                        <input type="radio" name="last_modification" value="custom" class="flat-red">
                ...
                <div class="form-group">
                    ...
                    <div class="form-radio">
                        <input type="radio" name="priority" value="none" class="flat-red"> <span>&nbsp;<?php echo trans('none'); ?></span>
                    </div>

                    <div class="form-radio">
                        <input type="radio" name="priority" value="automatically" class="flat-red" checked> <span>&nbsp;<?php echo trans('priority_none'); ?></span>
                    </div>
