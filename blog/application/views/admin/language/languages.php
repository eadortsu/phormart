            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-xs-12 col-lang">
                            <input type="radio" id="rb_type_1" name="text_direction" value="ltr" class="flat-red" checked>&nbsp;&nbsp;
                            <label for="rb_type_1" class="cursor-pointer"><?php echo trans("left_to_right"); ?></label>
                        </div>
                        <div class="col-sm-4 col-xs-12 col-lang">
                            <input type="radio" id="rb_type_2" name="text_direction" value="rtl" class="flat-red">&nbsp;&nbsp;
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-xs-12 col-lang">
                            <input type="radio" name="status" value="1" id="status1" class="flat-red" checked>
                            <label for="status1" class="option-label"><?php echo trans('active'); ?></label>
                        </div>
                        <div class="col-sm-4 col-xs-12 col-lang">
                            <input type="radio" name="status" value="0" id="status2" class="flat-red">
