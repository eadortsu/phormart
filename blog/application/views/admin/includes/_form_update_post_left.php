    ...
    <div class="box-body">
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                        <input type="radio" id="rb_visibility_1" name="visibility" value="1" class="flat-red" <?php echo ($post->visibility == 1) ? 'checked' : ''; ?>>&nbsp;&nbsp;
                        <label for="rb_visibility_1" class="cursor-pointer"><?php echo trans('show'); ?></label>
                    </div>
                    <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                        <input type="radio" id="rb_visibility_2" name="visibility" value="0" class="flat-red" <?php echo ($post->visibility == 0) ? 'checked' : ''; ?>>&nbsp;&nbsp;
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-12">
                        <input type="checkbox" name="is_slider" value="1" class="flat-red" <?php echo ($post->is_slider == 1) ? 'checked' : ''; ?>>
                    </div>
                </div>
            </div>
        <?php else: ?>
        ...
        <?php if (is_admin()): ?>
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-12">
                        <input type="checkbox" name="is_picked" value="1" class="flat-red" <?php echo ($post->is_picked == 1) ? 'checked' : ''; ?>>
                    </div>
                </div>
            </div>
        <?php else: ?>
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-12">
                    <input type="checkbox" name="need_auth" value="1" class="flat-red" <?php echo ($post->need_auth == 1) ? 'checked' : ''; ?>>
                </div>
            </div>
        </div>
