                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                                <input type="radio" name="location" value="header" id="menu_top"
                                       class="flat-red" <?php echo ($page->location == "header") ? 'checked' : ''; ?>>
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                                <input type="radio" name="location" value="footer" id="menu_footer"
                                       class="flat-red" <?php echo ($page->location == "footer") ? 'checked' : ''; ?>>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                                <input type="radio" name="page_active" value="1" id="page_enabled"
                                       class="flat-red" <?php echo ($page->page_active == 1) ? 'checked' : ''; ?>>
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                                <input type="radio" name="page_active" value="0" id="page_disabled"
                                       class="flat-red" <?php echo ($page->page_active == 0) ? 'checked' : ''; ?>>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                                <input type="radio" name="need_auth" value="1" id="need_auth_enabled"
                                       class="flat-red" <?php echo ($page->need_auth == 1) ? 'checked' : ''; ?>>
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                                <input type="radio" name="need_auth" value="0" id="need_auth_disabled"
                                       class="flat-red" <?php echo ($page->need_auth == 0) ? 'checked' : ''; ?>>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                                <input type="radio" name="title_active" value="1" id="title_enabled"
                                       class="flat-red" <?php echo ($page->title_active == 1) ? 'checked' : ''; ?>>
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                                <input type="radio" name="title_active" value="0" id="title_disabled"
                                       class="flat-red" <?php echo ($page->title_active == 0) ? 'checked' : ''; ?>>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                                <input type="radio" name="breadcrumb_active" value="1" id="breadcrumb_enabled"
                                       class="flat-red" <?php echo ($page->breadcrumb_active == 1) ? 'checked' : ''; ?>>
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                                <input type="radio" name="breadcrumb_active" value="0" id="breadcrumb_disabled"
                                       class="flat-red" <?php echo ($page->breadcrumb_active == 0) ? 'checked' : ''; ?>>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                                <input type="radio" name="right_column_active" value="1" id="right_column_enabled"
                                       class="flat-red" <?php echo ($page->right_column_active == 1) ? 'checked' : ''; ?>>
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                                <input type="radio" name="right_column_active" value="0" id="right_column_disabled"
                                       class="flat-red" <?php echo ($page->right_column_active == 0) ? 'checked' : ''; ?>>
