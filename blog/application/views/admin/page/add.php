            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="page_description"
                           placeholder="<?php echo trans("description"); ?> (<?php echo trans('meta_tag'); ?>)" value="<?php echo old('page_description'); ?>" <?php echo ($rtl == true) ? 'dir="rtl"' : ''; ?>>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="page_keywords"
                           placeholder="<?php echo trans('keywords'); ?> (<?php echo trans('meta_tag'); ?>)" value="<?php echo old('page_keywords'); ?>" <?php echo ($rtl == true) ? 'dir="rtl"' : ''; ?>>
                </div>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            <input type="radio" name="location" value="header" id="menu_top"
                                   class="flat-red" <?php echo (old("location") == "header" || old("location") == "") ? 'checked' : ''; ?>>
                            <label for="menu_top" class="option-label"><?php echo trans('header'); ?></label>
                        </div>
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            <input type="radio" name="location" value="footer" id="menu_footer"
                                   class="flat-red" <?php echo (old("location") == "footer") ? 'checked' : ''; ?>>
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            <input type="radio" name="page_active" value="1" id="page_enabled" class="flat-red" checked>
                            <label for="page_enabled" class="option-label"><?php echo trans('show'); ?></label>
                        </div>
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            <input type="radio" name="page_active" value="0" id="page_disabled" class="flat-red">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            <input type="radio" name="need_auth" value="1" id="need_auth_enabled"
                                   class="flat-red" <?php echo (old("need_auth") == 1) ? 'checked' : ''; ?>>
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            <input type="radio" name="need_auth" value="0" id="need_auth_disabled"
                                   class="flat-red" <?php echo (old("need_auth") == 0 || old("need_auth") == "") ? 'checked' : ''; ?>>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            <input type="radio" name="title_active" value="1" id="title_enabled"
                                   class="flat-red" <?php echo (old("title_active") == 1 || old("title_active") == "") ? 'checked' : ''; ?>>
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            <input type="radio" name="title_active" value="0" id="title_disabled"
                                   class="flat-red" <?php echo (old("title_active") == 0 && old("title_active") != "") ? 'checked' : ''; ?>>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            <input type="radio" name="breadcrumb_active" value="1" id="breadcrumb_enabled"
                                   class="flat-red" <?php echo (old("breadcrumb_active") == 1 || old("breadcrumb_active") == "") ? 'checked' : ''; ?>>
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            <input type="radio" name="breadcrumb_active" value="0" id="breadcrumb_disabled"
                                   class="flat-red" <?php echo (old("breadcrumb_active") == 0 && old("breadcrumb_active") != "") ? 'checked' : ''; ?>>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            <input type="radio" name="right_column_active" value="1" id="right_column_enabled"
                                   class="flat-red" <?php echo (old("right_column_active") == 1 || old("right_column_active") == "") ? 'checked' : ''; ?>>
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-lang">
                            <input type="radio" name="right_column_active" value="0" id="right_column_disabled"
                                   class="flat-red" <?php echo (old("right_column_active") == 0 && old("right_column_active") != "") ? 'checked' : ''; ?>>
