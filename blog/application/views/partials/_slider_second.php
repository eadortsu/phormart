    ...
    <?php foreach ($slider_posts as $item) : ?>
        ...
        <div class="first-tmp-slider-item">
            <a href="<?php echo lang_base_url() . 'post/' . html_escape($item->title_slug); ?>">
                <img src="<?php echo $img_bg_mid; ?>" data-src="<?php echo base_url() . $item->image_mid; ?>"
                     class="owl-lazy" alt="<?php echo html_escape($item->title); ?>" onerror="javascript:this.src='<?php echo $img_bg_mid; ?>'">
